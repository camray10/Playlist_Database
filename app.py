...
def add_playlist():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            form.name.errors.append('This Playlist already exist. Try again.')
...
def add_song():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            form.title.errors.append('This song already exist! Add another!')
            return render_template('new_song.html', form=form)

        flash('Your Song has been added!')
